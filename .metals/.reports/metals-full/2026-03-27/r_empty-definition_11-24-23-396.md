error id: file://<WORKSPACE>/ThirdPartyDisputeApiService.java:_empty_/HttpHeaders#setBearerAuth#
file://<WORKSPACE>/ThirdPartyDisputeApiService.java
empty definition using pc, found symbol in pc: _empty_/HttpHeaders#setBearerAuth#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 3567
uri: file://<WORKSPACE>/ThirdPartyDisputeApiService.java
text:
```scala
...
public class ThirdPartyDisputeApiService {
    ...
    public DisputeApiResponse submitDisputeToThirdParty(Long disputeId) {
        ...
        try {
            ...
            headers.setBearer@@Auth(apiToken);
